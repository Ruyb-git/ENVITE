"""
Django settings for envite project.
...
WSGI_APPLICATION = 'envite.wsgi.application'
...
#     'LOGIN_SERIALIZER': 'aaenvite.user.serialize.CustomJWTSerializer',
# }
...
#     'ROTATE_REFRESH_TOKENS': True,  # Gera novo refresh token ao atualizar
