...
class EventViewSet(viewsets.ModelViewSet):
    ...
    filter_backends = [filters.SearchFilter]  # Ativa filtro de busca
    search_fields = ['title', 'description']  # Busca pelo campo título
    ...
    @extend_schema(
        summary="Listar eventos",
        description="Lista eventos com paginação.\n\n"
                    "Aceita os parâmetros `page`, `size` e `search` para controle e busca.",
        parameters=[
            OpenApiParameter(name='page', description='Número da página', required=False, type=int),
            OpenApiParameter(name='size', description='Quantidade de itens por página', required=False, type=int),
            OpenApiParameter(name='search', description='Termo de busca no título', required=False, type=str),
        ],
        responses=EventSerializer,
    )
    def list(self, request, *args, **kwargs):
...
@extend_schema(
    summary="Listar meus eventos (como participante)",
    description="Lista eventos em que o usuário autenticado é participante.",
    responses=EventSerializer,
    parameters=[
        OpenApiParameter(name='page', description='Número da página', required=False, type=int),
        OpenApiParameter(name='size', description='Quantidade de itens por página', required=False, type=int),
