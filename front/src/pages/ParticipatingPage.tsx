...
const ParticipatingPage: React.FC = () => {
  ...
  const fetchEvents = async (pageNum: number) => {
    try {
      ...
      const response = await api.get<PaginatedEvents>('/api/v1/events/participating/', {
        params: {
          page: pageNum,
          size: 10,
        },
  ...
  return (
    <MainLayout>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Events I'm Participating In</h1>
        <Button
      ...
      {loading && events.length === 0 ? (
        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">You are not participating in any events at the moment.</p>
